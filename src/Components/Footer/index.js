    ...
    return (
        ...
        <div className="container mx-auto px-6">
          <div className="footer-content flex flex-wrap items-center justify-between gap-y-5 gap-x-7 py-5 text-center md:flex-nowrap">
              ...
              <ul className="mb-0 inline-flex list-none flex-wrap gap-3 pl-0 sm:gap-4">
                ...
                <li className="inline-block align-middle">
                  ...
                  >
                    ...
                    <span className="back absolute left-0 top-0 flex h-full w-full translate-y-full items-center justify-center rounded bg-primary text-grey transition-all duration-500 group-hover:translate-y-0 group-hover:text-gray-200">
                      <svg
                        stroke="currentColor"
                        fill="currentColor"
                        strokeWidth={0}
            ...
            <p className="mb-0 w-full text-sm md:w-auto text-gray-200">
              © 2023, All right reserved
              <a
                className="pl-1.5 text-sm font-medium text-heading no-underline hover:text-primary"
                href="/"
              >
                Pankaj
              </a>
